...
/****** Object:  Database [juego]    Script Date: 13/8/2016 11:38:46 a. m. ******/
CREATE DATABASE [juego]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'juego', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\juego.mdf' , SIZE = 4288KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'juego_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\juego_log.ldf' , SIZE = 1072KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [juego] SET COMPATIBILITY_LEVEL = 120
GO
...
ALTER DATABASE [juego] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [juego] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [juego] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
